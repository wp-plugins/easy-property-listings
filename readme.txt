...
== Changelog ==
= 1.2.2: January 13, 2015 =
* Fix: Session Start causing issues with some PHP versions which prevented plugin activation.
* Note: We have been working on the next major release which has taken longer than expected. The next version is a substantial update with major changes to the core code and adds many new filters, functions and features.
