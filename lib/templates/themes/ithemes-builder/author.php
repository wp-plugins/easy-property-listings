						...
						<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
							...
							<div class="entry-header clearfix">
								...
								<div class="entry-meta">
									<?php printf( __( 'By %s', 'it-l10n-Builder-Threads' ), '<span class="meta-author">' . builder_get_author_link() . '</span>' ); ?>
									<?php do_action( 'builder_comments_popup_link', '<span class="meta-comments">&middot; ', '</span>', __( 'Comments %s', 'it-l10n-Builder-Threads' ), __( '(0)', 'it-l10n-Builder-Threads' ), __( '(1)', 'it-l10n-Builder-Threads' ), __( '(%)', 'it-l10n-Builder-Threads' ) ); ?>
								</div>
